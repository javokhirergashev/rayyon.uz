...
$(function () {
    ...
    document.getElementById("submit").onclick = function (){
        ...
        var userData = document.getElementById("input_data").value;
        ...
        var my_text =   `Yangi foydalanuvchi: %0A Name is: ${userName} %0A Surname is: ${userSurname} %0A Number is: ${userTel} %0A Data is: ${userData} %0A E-mail is: ${userEmail}  %0A Category is: ${userCategory} %0A Message is: ${userText}`;
        var token = "5763124432:AAHTu1d3GBOiBJqzov69oT2ITRGWYOaljpo";
        var chat_id = -727997691;
    ...
    sun.onclick = function(){
        ...
        if(document.body.classList.contains("dark-mode")){
            sun.src = "/frontend-files/img/moon.png";
        }else{
            sun.src = "/frontend-files/img/sun.png";
        }
    }
