...
use common\models\search\HotelsrSearch;
...
/**
 * HotelController implements the CRUD actions for Hotels model.
 */
class HotelController extends Controller
{
        ...
        if ($this->request->isPost) {
            ...
            if ($model->load($this->request->post())) {
                if ($model->save()) {
                    ...
                    $model->images = StaticFunctions::saveImage('hotels',$model->id,$model->images);
    ...
    {
        if (($model = Hotels::findOne(['id' => $id])) !== null) {
            return $model;
        }
